...
public class CourseCreate {
    ...
    @Builder
    public CourseCreate(Long instructorId, String courseName, String introduce, int maxReservationCount, int maxWaitingCount, int reservationDeadTime, int cancelDeadTime, LocalDate coursePeriodStart, LocalDate coursePeriodEnd, List<CourseDayDto> courseDays) {
